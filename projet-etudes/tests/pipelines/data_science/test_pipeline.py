...
from projet_etudes.pipelines.data_science import create_pipeline as create_ds_pipeline
from projet_etudes.pipelines.data_science.nodes import split_data
