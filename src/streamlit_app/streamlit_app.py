...
from streamlit_logic import send_message_api, load_posts, get_posts, top_users_per_category, trending_keywords, posts_per_hour
...
if main_section == "Chatbot":
    ...
    st.subheader(StreamlitConfig().title)
    ...
    if user_input:
        ...
        verdict, color, explanation = send_message_api(user_input)
        response = f"""
