class ColorChart:
    ...
    @classmethod
    def get_bg_main(cls) -> str:        return cls.GLASS_BG
    @classmethod
    def get_bg_sidebar(cls) -> str:     return cls.GLASS_BG
    @classmethod
    def get_bg_card(cls) -> str:        return cls.GLASS_BG
    @classmethod
    def get_accent_primary(cls) -> str: return cls.ACCENT_PRIMARY
    @classmethod
    def get_accent_soft(cls) -> str:    return cls.ACCENT_SOFT
    @classmethod
    def get_text_main(cls) -> str:      return cls.TEXT_MAIN
    @classmethod
    def get_text_muted(cls) -> str:     return cls.TEXT_MUTED
    @classmethod
    def get_success_color(cls) -> str:  return cls.SUCCESS_COLOR
    @classmethod
    def get_warning_color(cls) -> str:  return cls.WARNING_COLOR
    @classmethod
    def get_yellow(cls) -> str:         return cls.YELLOW
